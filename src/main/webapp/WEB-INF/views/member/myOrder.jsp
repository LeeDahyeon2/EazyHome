...
<div class="xans-element- xans-order xans-order-empty "><p>주문내역이 없습니다.</p>
</div>
</c:when>
<c:otherwise>
...
<thead><tr >
			...
			<c:forEach var="order" items="${orderList}">
                <tr class="xans-record-">
                    <td class="thumb gClearLine"><a href="../item/itemDetail?itemCode=${order.itemCode}"><img src="${pageContext.request.contextPath}/resources/upload/item/${order.itemFile}" onerror="this.src='//img.echosting.cafe24.com/thumb/img_product_small.gif';" alt=""/></a></td>
                    <td  style="text-align:center">
                        <strong class="name"><a href = "../item/itemDetail?itemCode=${order.itemCode}" style="text-align:center" class="ec-product-name" >${order.itemName}</a></strong> 
</td>
                    ...
                    <td>
                        <span class="">
                            <span class="ec-base-qty" style="text-align:center">${order.quantity}</span>
                        </span>
                    </td>
                    <td style="text-align:center">
						<strong><span id="sum_price_front0">${order.quantity * order.price}</span>원</strong>
					</td>
                </tr>
                </c:forEach>
</tbody> 
