        ...
        <div class="board_view_wrap">
            <div class="board_view">
                ...
                <div class="info">
                    <dl>
                        <dt>번호</dt>
                        <dd>${content_view.postnum}</dd>
                    </dl>
                    <dl>
                        <dt>글쓴이</dt>
                        <dd>${content_view.publisher}</dd>
                    </dl>
                    <dl>
                        <dt>작성일</dt>
                        <dd>${content_view.createDate}</dd>
                    </dl>
                    <dl>
                        <dt>조회수</dt>
            ...
            <div class="bt_wrap">
                <a href="./delete">삭제</a>
                <a href="./list?Community=${Comm}" class="on">목록</a>
                <a href="./modify?Community=${Comm}&postnum=${content_view.postnum}">수정</a>
            </div>
        </div>
    </div>
