			...
			<br>
                <div>
                    ...
                    <span class="box int_name"style="height:300px;">
                        <textarea name="itemInfo" class="int" style="height:280px;"></textarea>
                    </span>
                    <span class="error_next_box"></span>
                </div>
                <div>
                    <h3 class="join_title"><label for="name">상품 기능</label></h3>
                    <span class="box int_name"style="height:300px;">
                        <textarea name="detail" class="int" style="height:280px;"></textarea>
                    </span>
                    <span class="error_next_box"></span>
                </div>
